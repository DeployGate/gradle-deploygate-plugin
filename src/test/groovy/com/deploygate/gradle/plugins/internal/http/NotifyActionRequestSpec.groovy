...
class NotifyActionRequestSpec extends Specification {
    def "toEntity should build an entity successfully"() {
        ...
        when:
        def entity = request.toEntity() // do not throw an exception
    ...
    def "buildNameValuePairs should contain parameters"() {
        ...
        when:
        def pairs = request.buildNameValuePairs() // do not throw an exception
        ...
        when:
        request = new NotifyActionRequest(notifyKey, action)
        request.setParameter("param1", "value1")
        request.setParameter("param2", null)
        pairs = request.buildNameValuePairs()
